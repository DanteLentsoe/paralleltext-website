...
import { SavedComparisonsType } from '@/pages/app'

type ComparisonHistoryProps = {
  comparisons: SavedComparisonsType[]
  onLoad: (comparison: SavedComparisonsType) => void
...
export const ComparisonHistory: FC<ComparisonHistoryProps> = ({
  ...
  return (
    <>
      <Card className="bg-white shadow-lg rounded-xl overflow-hidden w-full">
        <CardHeader className="border-b bg-gray-50">
          <CardTitle className="text-[#003B5C] px-4">
            Saved Comparisons
          </CardTitle>
        </CardHeader>
